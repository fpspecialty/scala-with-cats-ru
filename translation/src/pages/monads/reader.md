...
Создание программ, принимающих конфигурацию в качестве параметра,
является классическим примером использования `Reader`.
...
и проверять её относительно конкретной полученной информации о пользователе:
...
от простых техник вроде методов с множественными списками параметров,
техник с использованием неявных параметров и тайпклассов,
до таких сложных техник, как cake pattern и фреймворков внедрения зависимостей (DI frameworks).

`Reader` наиболее полезен в следующих случаях:
...
- нужна возможность тестирования
  частей программы в режиме изоляции.

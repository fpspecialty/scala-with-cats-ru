...
последовательности операций. Они называются *контравариантными*
и *инвариантными функторами* соответственно.
...
`imap` позволяет определить их с помощью
...
такие как JSON в Play [`Format`][link-play-json-format]
...
то мы можем выйти за пределы функторов
